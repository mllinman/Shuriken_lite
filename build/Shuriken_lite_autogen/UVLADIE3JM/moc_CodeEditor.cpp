...
namespace {
struct qt_meta_stringdata_CppHighlighter_t {
    uint offsetsAndSizes[2];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CppHighlighter_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CppHighlighter_t qt_meta_stringdata_CppHighlighter = {
    {
        QT_MOC_LITERAL(0, 14)   // "CppHighlighter"
    },
    "CppHighlighter"
};
...
Q_CONSTINIT static const uint qt_meta_data_CppHighlighter[] = {
...
Q_CONSTINIT const QMetaObject CppHighlighter::staticMetaObject = { {
    ...
    qt_meta_stringdata_CppHighlighter.offsetsAndSizes,
    qt_meta_data_CppHighlighter,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CppHighlighter_t,
        // Q_OBJECT / Q_GADGET
...
void *CppHighlighter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CppHighlighter.stringdata0))
