...
void NotificationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NotificationManager::*)(const QStringList & )>(_a, &NotificationManager::notificationsListed, 0))
            return;
    }
}
