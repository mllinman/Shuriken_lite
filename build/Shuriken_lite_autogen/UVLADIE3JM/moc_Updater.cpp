...
Q_CONSTINIT static const qt_meta_stringdata_Updater_t qt_meta_stringdata_Updater = {
    {
        ...
        QT_MOC_LITERAL(8, 15),  // "updateAvailable"
        QT_MOC_LITERAL(24, 0),  // ""
...
void Updater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateAvailable((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Updater::updateAvailable; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Updater::updateAvailable(QString _t1)
{
